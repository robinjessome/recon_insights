<div class="flatpickr grid grid-cols-12 gap-x-4 scheduling_modal"
    x-data="{
        chosenDate: @entangle('wireStartDate'), 
        scheduleButton: 'Choose a date',
        intro: 'Select a date &amp; time to schedule publishing:',
...
>
   ...
   >
    ...
    x-model="chosenDate"
    x-on:input="scheduleButton = 'Schedule this survey!', intro = 'Survey will publish'"
